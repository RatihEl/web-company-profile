<!-- disiini kita masukan atau includkan terlebih dahulu inc koneksinya -->
<?php 
...
<head>
  ...
  <!-- link pooper supaya bostrap4 bisa terpakai -->
...
<!-- Mengatur ukuran foto didalam list gambar summernote -->
